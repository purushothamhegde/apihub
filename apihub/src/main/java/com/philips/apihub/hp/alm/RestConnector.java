...
public class RestConnector
{
    ...
    public String buildDefectCollectionUrl(String entityType, String queryParams) throws Exception
    {
    	String tempurl="";
        ...
        if(StringUtils.isNotBlank(domain) && StringUtils.isNotBlank(project))
        {
    		...
    		tempurl=String.format("/qcbin/rest/domains/%s/projects/%s/%s", domain, project, entityType);
        	...
        	else
        	{
                ...
                URI uri = new URI( String.format(tempurl+ "%s" ,URLEncoder.encode( queryParams, "UTF8" ) ) );
                tempurl= uri.toString();
        		

        		
        	}
            System.out.println("Defect Url::" + tempurl);
