...
public final class Dao
{
    ...
    public static String readDefects(String sProjectId) throws Exception
    {
    	String runDefectssUrl ="";
    	if (sProjectId.equals("")) {
    		runDefectssUrl =  connector().buildDefectCollectionUrl("defects","") ;
    	}
    	
    	else
    	{
    		runDefectssUrl =  connector().buildDefectCollectionUrl("defects","{user-01["+ sProjectId +"]}") ;
    		
    	}	
    	
        return connector().get(runDefectssUrl, String.class, null, null).toString();
    }
