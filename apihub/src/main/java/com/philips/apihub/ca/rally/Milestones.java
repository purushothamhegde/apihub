...
public class Milestones
{
    ...
    private List<_tagsNameArray> _tagsNameArray;
    ...
    public void set_tagsNameArray(List<_tagsNameArray> _tagsNameArray){
        this._tagsNameArray = _tagsNameArray;
    }
    public List<_tagsNameArray> get_tagsNameArray(){
